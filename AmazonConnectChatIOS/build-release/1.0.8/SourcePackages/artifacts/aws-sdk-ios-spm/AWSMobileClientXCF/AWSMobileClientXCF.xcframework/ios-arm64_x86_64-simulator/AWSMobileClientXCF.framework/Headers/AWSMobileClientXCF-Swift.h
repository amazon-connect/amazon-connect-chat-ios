...
#ifndef AWSMOBILECLIENTXCF_SWIFT_H
#define AWSMOBILECLIENTXCF_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="AWSMobileClientXCF",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC18AWSMobileClientXCF15AWSMobileClient")
...
@interface AWSMobileClient (SWIFT_EXTENSION(AWSMobileClientXCF)) <AWSCognitoAuthDelegate>
...
@interface AWSMobileClient (SWIFT_EXTENSION(AWSMobileClientXCF)) <AWSIdentityProviderManager>
...
@interface AWSMobileClient (SWIFT_EXTENSION(AWSMobileClientXCF))
...
SWIFT_CLASS("_TtC18AWSMobileClientXCF15SignInUIOptions")
